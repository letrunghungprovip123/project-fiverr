  ...
  const icon = {
    ...
    5: (
      <svg
        ...
        fill="none"
      >
        <g stroke="#222325" stroke-width="1.6" stroke-linejoin="round">
    ...
    6: (
      <svg
        ...
        fill="none"
      >
        <g clip-path="url(#clip0_2578_16622)">
          <g
            clip-path="url(#clip1_2578_16622)"
            stroke="#222325"
            stroke-width="1.6"
            stroke-linecap="round"
            stroke-linejoin="round"
    ...
    <div className="container py-10 px-5 sm:px-5 xl:px-0">
      <div className="bg-[url('https://fiverr-res.cloudinary.com/image/upload/f_auto,q_auto/v1/attachments/generic_asset/asset/84c449beda884aa8f9f72023e2d8b3fd-1705308514872/hero-lg-x1.png')]  h-[300px] md:h-[468px] lg:h-[560px] w-full bg-cover bg-center rounded-3xl flex flex-col items-center ">
        <div className="flex justify-center items-center flex-col h-full">
          <h3 className="text-white text-[30px] lg:text-[45px] xl:text-[60px] font-medium text-center">
            Scale your professional <br /> workforce with{" "}
            <span className="font font-thin">freelancers</span>
          </h3>
          <div className="mt-7">
            <WrapperSuggestJob>
              <FormSearchProduct />
      ...
      <div className="mt-10">
        <div className="flex items-center justify-between flex-wrap gap-5 xl:gap-0">
          ...
          <div className="flex items-start p-5 h-[129px] w-[129px] box-shadow rounded-2xl bg flex-col gap-5">
            ...
            <Link className="text-sm font-semibold">AI Services</Link>
          </div>
          <div className="flex items-start p-5 h-[129px] w-[129px] box-shadow rounded-2xl bg flex-col gap-5">
            <div className="">{icon[7]}</div>
            <Link className="text-sm font-semibold">Bussiness</Link>
          </div>
          <div className="flex items-start p-5 h-[129px] w-[129px] box-shadow rounded-2xl bg flex-col gap-5">
            <div className="">{icon[8]}</div>
            <Link className="text-sm font-semibold">Consulting</Link>
          </div>
          <div className="flex items-start p-5 h-[129px] w-[129px] box-shadow rounded-2xl bg flex-col gap-5">
            <div className="">{icon[9]}</div>
            <Link className="text-sm font-semibold">Programming & Tech</Link>
          </div>
        </div>
      </div>
    </div>
